...
export const HomeScreen: React.FC<HomeProps> = React.memo(() => {
  ...
  const crebitButtonProps = useMemo(
    () => ({
      ...
      gradientColors:
        homeState.activeSection === 'crebit'
          ? ['rgba(191, 170, 45, 0.25)', 'rgba(153, 153, 153, 0.25)']
          : ['#063939ff', '#0a3131ff'],
      backgroundColor:
        homeState.activeSection === 'crebit' ? undefined : '#12696B26',
      borderWidth: 0.25,
      borderColor: homeState.activeSection === 'crebit' ? '#F1FFBF' : '#12696B',
      padding: 8,
    }),
  ...
  const compareButtonProps = useMemo(
    () => ({
      ...
      gradientColors:
        homeState.activeSection === 'compare'
          ? ['rgba(191, 170, 45, 0.25)', 'rgba(153, 153, 153, 0.25)']
          : ['#063939ff', '#0a3131ff'],
      backgroundColor:
        homeState.activeSection === 'compare' ? undefined : '#12696B26',
      borderWidth: 0.25,
      borderColor:
        homeState.activeSection === 'compare' ? '#F1FFBF' : '#12696B',
      padding: 8,
    }),
    [homeState.activeSection, handleSectionChange],
  );
  ...
  const renderCrebitSection = useMemo(
      ...
      <View style={styles.crebitContainer}>
        ...
        <View style={styles.swipeButtonContainer}>
          <SwipeToPayButton
            ...
            disabled={
              !homeState.sendAmount || parseFloat(homeState.sendAmount) <= 0
            }
          />
        </View>
    ...
    [
      homeState.exchangeRate,
      homeState.sendAmount,
      homeState.receiveAmount,
      handleSwapCurrencies,
      handleSendAmountChange,
      handleCurrencyPress,
      handleExchangeInitiation,
          ...
          <LinearGradient
            ...
            <View style={styles.exchangeRate}>
              <StyledText style={styles.rateText}>
                {homeState.exchangeRate.rate.toFixed(4)}{' '}
                {homeState.exchangeRate.from.code} = 1{' '}
                {homeState.exchangeRate.to.code}
              </StyledText>
            </View>
